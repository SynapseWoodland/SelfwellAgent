...
> **状态**: Draft
> **对应模块**: M8
> **对应 TDS**: `docs/architecture/TDS/TDS-M8-recall.md`
...
## 四、Recall Safety（J1-J4 逐条约束）

> **J1-J4 定义来源**：TDS-M8 §3.1 = ADR-0017 §3.1-3.4
>
> **J1-J4 编号对照**：
> - J1：永不评判照片前后变化
> - J2：永不评判反馈质量
...
### Scenario: Layer 1 Prompt hardcode 约束模型（J1-J4）（M8-FR-03）
```gherkin
Given LLM 接收 Recall Prompt
When 模型生成输出
Then 4 条"绝对不可违反"已 hardcode 在输入中（J1/J2/J3/J4）
And 模型输出不含评判性语句
And 不出现"比之前好/差"
```
...
> **说明**：合规红线详见 [ATDD-Shared.md §三](../ATDD-Shared.md#三合规红线)
...
- 用户旅程：详见 [ATDD-Journey.md §五](../ATDD-Journey.md#五回忆旅程)
