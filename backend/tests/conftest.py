...
def mock_llm(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(app.llm, "text_llm", mock_text, raising=True)
    monkeypatch.setattr(app.llm, "multimodal_llm", mock_multi, raising=True)
    monkeypatch.setattr(app.llm, "llm", mock_text, raising=True)
