...
|-----------|--------|---------------|
| `feature` | REQUIREMENT, ARCH_DESIGN, PRE_MORTEM, ATDD, PLAN, CODE, VERIFY, SECURITY_TEST, DEPLOY, REGRESSION, SIGN_OFF, DATA_REPLAY, INCIDENT_RESPONSE, OPS_LOOP, SKILL_UPDATE | REQUIREMENT |
...
|---|---|---|---|---|
| `REQUIREMENT` | `requirement-analyst` | `ARCH_DESIGN` | `harness/context/phase-checklist.md` | `evidence/01-requirement.md` |
...
| `DATA_REPLAY` | `requirement-analyst` | `REQUIREMENT` | `harness/context/phase-checklist.md` | `harness/evidence/12-data-replay.md` |
